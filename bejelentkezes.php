...
<header>
    ...
    <nav class="menu">
        ...
        echo '
        <li><a class="active" href="bejelentkezes.php">Profil</a></li>
    ...
    <section class="tartalom">
        ...
        <?php
            ...
            <fieldset>
                ...
                echo '
                    <img src="profil/'.$_SESSION["user"]->getKep().'" alt="profilkep" width="400" height="400"/>
                    <p>Teljes név: '.$_SESSION["user"]->getNev().'</p>
